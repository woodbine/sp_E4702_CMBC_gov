...
entity_id = "E4702_CMBC_gov"
url = "http://www.calderdale.gov.uk/council/finances/income-spending/index.jsp"
errors = 0
data = []
...
for link in links:
    ...
    for links_url in links_urls:
        if '.csv' in links_url['href']:
            url = 'http://www.calderdale.gov.uk/council/finances/income-spending/' +links_url['href']
            csvYr = links_url['href'].split('/')[0]
            csvMth = links_url['href'].split('/')[1][:3]
